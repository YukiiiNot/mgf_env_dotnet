...
Examples:
  dotnet run --project src/DevTools/MGF.LegacyAuditCli -- scan --root ""\\Truenas\zan4k pool\OFFLOAD 2"" --out ""C:\mgf_audit_out\OFFLOAD_2""
  dotnet run --project src/DevTools/MGF.LegacyAuditCli -- scan --root ""\\Truenas\zana 10tb - 01\Sector 2"" --out ""C:\mgf_audit_out\ZANA10_Sector2""");
