...
- `src/MGF.Tools.Migrator` — migrations + lookup seeding
...
# deliver (see RUNBOOK_DELIVERY for the full sequence)
...
1. Read `ROADMAP.md` and pick a small, isolated milestone.
2. Read `docs/RUNBOOK_DELIVERY.md` to understand the current “golden path.”
