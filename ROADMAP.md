...
1. Delivery runbook + operator workflow solidification
   - Acceptance: RUNBOOK_DELIVERY.md is used successfully by a second operator end-to-end.
...
- Avoid overlapping files. Use ownership zones:
  - Email subsystem: `src/MGF.Worker/Email/`
  - Delivery: `src/MGF.Worker/ProjectDelivery/`
  - Bootstrap/Archive: `src/MGF.Worker/ProjectBootstrap/`
  - Templates/Contracts: `docs/templates/`, `docs/infra/`
