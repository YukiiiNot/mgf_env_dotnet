...
| `config/appsettings*.json`, `src/Services/MGF.Api/appsettings*.json`, `src/Services/MGF.Worker/appsettings*.json`, `src/Data/MGF.Infrastructure/Options/Options.cs` | `docs/03-contracts/configuration/config-reference.md`, `docs/03-contracts/configuration/env-vars.md` | Medium (options + JSON reference) |
