...
Status  
Needs Review. Reason: Phase status may be outdated.
...
This document moved to [/docs/02-architecture/database-phase1.md](/docs/02-architecture/database-phase1.md).
