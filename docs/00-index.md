...
- Business concepts catalog: [02-architecture/business-concepts-catalog.md](02-architecture/business-concepts-catalog.md)
- Domain/persistence map: [02-architecture/domain-persistence-map.md](02-architecture/domain-persistence-map.md)
- Extension playbook: [02-architecture/extension-playbook.md](02-architecture/extension-playbook.md)
- Testing and verification: [02-architecture/testing-and-verification.md](02-architecture/testing-and-verification.md)
...
### Decisions
- ADR template: [06-decisions/adr-template.md](06-decisions/adr-template.md)
