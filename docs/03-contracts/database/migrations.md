...
Source of truth: `src/Data/MGF.Infrastructure/Migrations/*`, `.github/workflows/migrate-staging.yml`, `.github/workflows/migrate-prod.yml`
Change control: Update when migration workflow or deployment gates change.
Last verified: 2025-12-30

## Summary
- Migrations live in `src/Data/MGF.Infrastructure/Migrations/`.
