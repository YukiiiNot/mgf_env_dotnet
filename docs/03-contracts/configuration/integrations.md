...
Source of truth: `src/Integrations/MGF.Integrations.Dropbox/**`, `src/Services/MGF.Worker/Email/**`, `src/Services/MGF.Api/Square/**`, `config/appsettings*.json`, `tools/dev-secrets/secrets.required.json`
