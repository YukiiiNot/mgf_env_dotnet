...
Source of truth: `config/appsettings*.json`, `src/MGF.Api/appsettings*.json`, `src/MGF.Worker/appsettings*.json`, `src/MGF.Infrastructure/Options/Options.cs`
...
- Options bindings live in `src/MGF.Infrastructure/Options/Options.cs`.
