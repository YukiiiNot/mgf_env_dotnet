...
Purpose  
Define the concurrency and isolation strategy for shared Dev infrastructure.

Audience  
Engineers running workflows against shared Dev DB and storage roots.

Scope  
Shared Dev concurrency hazards, safety rails, and workflow lock strategy. Does not replace runbooks.
...
- ../03-contracts/events/jobs.md
- ../05-runbooks/delivery.md
- ../04-guides/how-to/e2e-email-verification.md
