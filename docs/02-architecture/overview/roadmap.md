...
**Doc Type:** Reference
**Status:** Draft
**Status Notes:** Note: Roadmap is directional and may change.
...
| Desktop tooling (WPF) | Started (skeleton) | `MGF.Desktop.Shared`, `MGF.DevConsole.Desktop` | Minimal Ops Console MVP |

### Next 30 days (ship and stabilize)
1. Delivery runbook + operator workflow solidification
   - Acceptance: delivery.md is used successfully by a second operator end-to-end.
...
- Avoid overlapping files. Use ownership zones:
  ...
  - Templates/Contracts: `artifacts/templates/`, `infra-contracts.md`
