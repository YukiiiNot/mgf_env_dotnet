...
public sealed class ProjectsViewModelTests
{
    ...
    public async Task Start_DoesNotPoll_WhenDisconnected()
    {
        ...
        var client = new FakeProjectsApiClient();
        var viewModel = new ProjectsViewModel(client, store);
    ...
    private sealed class FakeProjectsApiClient : IProjectsApiClient
    {
        ...
        public Task<ProjectsApiClient.ProjectsListResponseDto> GetProjectsAsync(
            int limit,
            ...
            CancellationToken cancellationToken)
        {
            ...
            return Task.FromResult(new ProjectsApiClient.ProjectsListResponseDto(Array.Empty<ProjectsApiClient.ProjectListItemDto>(), null));
        }

        public Task<ProjectsApiClient.ProjectDetailDto> GetProjectAsync(string projectId, CancellationToken cancellationToken)
        {
