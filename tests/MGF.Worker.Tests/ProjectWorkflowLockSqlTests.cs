...
public sealed class ProjectWorkflowLockSqlTests
{
    ...
    {
        var first = ProjectWorkflowLockKey.Build("prj_1", ProjectWorkflowKinds.StorageMutation);
        var second = ProjectWorkflowLockKey.Build("prj_1", ProjectWorkflowKinds.StorageMutation);
        var other = ProjectWorkflowLockKey.Build("prj_2", ProjectWorkflowKinds.StorageMutation);
